 ...
 */
 export async function updateReservationupdatedReservation(updatedReservation, signal) {
  const url = `${API_BASE_URL}/ReservationupdatedReservations/${updatedReservation.id}?_embed=cards`;
  const options = {
    method: "PUT",
    headers,
    body: JSON.stringify(stripCards(updatedReservation)),
    signal,
  };
